...
class ConferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create conference" do
    assert_difference('Conference.count') do
      post conferences_url, params: { conference: { name: @conference.name, password: @conference.password, room: @conference.room } }
    end
  ...
  test "should update conference" do
    patch conference_url(@conference), params: { conference: { name: @conference.name, password: @conference.password, room: @conference.room } }
